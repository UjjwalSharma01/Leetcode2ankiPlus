      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="-mr-2 flex items-center sm:hidden">
            <button
              type="button"
              className="inline-flex items-center justify-center p-2 rounded-md text-white hover:bg-green-700 dark:hover:bg-gray-700"
              aria-expanded="false"
      ...
      <div className={`${isMenuOpen ? 'block' : 'hidden'} sm:hidden`}>
        <div className="px-2 pt-2 pb-3 space-y-1">
          ...
          <button
            ...
            className="text-white w-full text-left block bg-green-700 dark:bg-gray-700 hover:bg-green-800 dark:hover:bg-gray-600 px-3 py-2 rounded-md text-base font-medium mt-2"
          >
            Logout
          </button>
        </div>
